...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 0)
            {
                logger.LogError("Error: zero input.");             
            }
            if (lines.Length == 1)
            {
                logger.LogWarning("Warning: only one line of input.");
            }
            ...
            /*var distance = new double[locations.Length];*/
            double distance = 0;
            ...
            logger.LogInfo($"First Taco Bell location is {tacoBell1.Name} and the second Taco Bell location is {tacoBell2.Name}. These two Taco Bells are the furtherst apart than any other Taco Bell on our list.");
        }
    }
}
